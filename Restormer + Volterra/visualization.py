# E:\restormer+volterra\Restormer + Volterra\visualization.py
# ----------------------------------------------------------
# 수정은 아래 CONFIG 부분만 하면 됨.
# 실행: 그냥 python visualization.py
...
DISTORTED_IMAGE = r"E:\restormer+volterra\data\CSD\Test\Snow\111.tif"
GT_IMAGE        = r"E:\restormer+volterra\data\CSD\Test\Gt\111.tif"

OUTPUT_IMAGE = r"E:\restormer+volterra\results\visualize_results\visualization_result_csd.png"

RESIZE_SIZE = 256      # 0이면 원본 해상도 유지
USE_AMP = True
USE_TILE = False       # 큰 이미지면 True 추천
TILE_SIZE = 256
TILE_OVERLAP = 32
