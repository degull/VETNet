...
- Follow `../experiments/PROTOCOL.md` for every table.
- Record every result in `../experiments/results_template.csv` before copying it into the paper.
- Never directly rank retrained VTN against zero-shot or reported baselines unless the protocol difference is explicitly marked.
